...
combined <- read_csv("~/WP-Efficiency-Performance/output/26_combine_data/2017-05-18 11:03:46 72143e/combined.csv")
vars <- c("in_degree_skew", "out_degree_skew", "N_c", "Delta_c", "degree_mean", "mean_editors", "article_count", "contributor_count", "first_assessment", "mean_article_age", "revision_count")
