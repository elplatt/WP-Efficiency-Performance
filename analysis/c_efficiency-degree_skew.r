...
vars <- c("in_degree_skew", "out_degree_skew", "N_c", "Delta_c", "mean_editors", "article_count", "contributor_count", "first_assessment", "mean_article_age", "revision_count")
...
summary(m_eff_out)
coefplot(m_eff_out,mar=c(1,6,6,1),main="C-Efficiency")
