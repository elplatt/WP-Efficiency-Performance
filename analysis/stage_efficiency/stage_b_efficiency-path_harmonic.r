...
vars <- c("path_harmonic", "degree_mean", "stage_N_b", "stage_Delta_b", "connectivity", "mean_editors", "article_count", "contributor_count", "first_assessment", "mean_article_age", "revision_count")
